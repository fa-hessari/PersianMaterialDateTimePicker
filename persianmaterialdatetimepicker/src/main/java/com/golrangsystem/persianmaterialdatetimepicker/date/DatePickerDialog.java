 ...
 */
package com.golrangsystem.persianmaterialdatetimepicker.date;
...
import com.golrangsystem.persianmaterialdatetimepicker.HapticFeedbackController;
import com.golrangsystem.persianmaterialdatetimepicker.R;
import com.golrangsystem.persianmaterialdatetimepicker.TypefaceHelper;
import com.golrangsystem.persianmaterialdatetimepicker.Utils;
import com.golrangsystem.persianmaterialdatetimepicker.utils.LanguageUtils;
import com.golrangsystem.persianmaterialdatetimepicker.utils.PersianCalendar;
...
public class DatePickerDialog extends DialogFragment
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      mPersianCalendar.setPersianDate(savedInstanceState.getInt(KEY_SELECTED_YEAR),
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    if (hasMiladiButton) {
      ...
      if (mChangeToMiladiString != null) {
        ...
        changeToMiladiBt.setText(mChangeToMiladiResId);
      }
      if (onChangeToMiladiDateClickListener != null) {
        changeToMiladiBt.setOnClickListener(v -> {
          onChangeToMiladiDateClickListener.onChangeToMiladiDateClicked(DatePickerDialog.this,
              mPersianCalendar.get(Calendar.YEAR), mPersianCalendar.get(Calendar.MONTH),
  ...
  private void updateDisplay(boolean announce) {
    ...
    String monthAndDayText = LanguageUtils.getPersianNumbers(
        mPersianCalendar.getPersianMonthName() + " " + mPersianCalendar.getPersianDay());
  ...
  /**
   * Set the label for the ChangeToMiladi button (max 12 characters)
   *
   * @param changeToMiladiString A literal String to be used as the ChangeToMiladi button label
   */
  @SuppressWarnings("unused") public void setChangeToMiladiText(String changeToMiladiString) {
    mChangeToMiladiString = changeToMiladiString;
  }

  /**
   * Set the label for the ChangeToMiladi button (max 12 characters)
   *
   * @param changeToMiladiResId A resource ID to be used as the ChangeToMiladi button label
   */
  @SuppressWarnings("unused") public void setChangeToMiladiText(
      @StringRes int changeToMiladiResId) {
    mChangeToMiladiString = null;
    mChangeToMiladiResId = changeToMiladiResId;
  }

  /**
   * Set the text color of the ChangeToMiladi button
   *
  ...
  public interface OnChangeToMiladiDateClickListener {
