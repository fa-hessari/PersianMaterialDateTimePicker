 ...
 */
package com.golrangsystem.persianmaterialdatetimepicker.multidate;
...
import com.golrangsystem.persianmaterialdatetimepicker.multidate.MonthAdapter.CalendarDay;
...
public abstract class MonthView extends View {
  ...
  protected void initView() {
    ...
    Typeface typeface =
        Typeface.create(TypefaceHelper.get(getContext(), mController.getTypeface()), Typeface.BOLD);
  ...
  protected int getInternalDayFromLocation(float x, float y) {
    ...
    int column =
        (int) (mNumDays - ((x - dayStart) * mNumDays) / (mWidth - dayStart - mEdgePadding));
