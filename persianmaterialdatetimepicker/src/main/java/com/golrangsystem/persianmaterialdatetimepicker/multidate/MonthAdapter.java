...
import com.golrangsystem.persianmaterialdatetimepicker.multidate.MonthView.OnDayClickListener;
  ...
  private void notifySelectedDays(CalendarDay day) {
    ...
    if (mSelectedDays.size() > 1 && toRemove != null) {
      ...
      Collections.sort(mSelectedDays, new Comparator<PersianCalendar>() {
        @Override public int compare(PersianCalendar o1, PersianCalendar o2) {
