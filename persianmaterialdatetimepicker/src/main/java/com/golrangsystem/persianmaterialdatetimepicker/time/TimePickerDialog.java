 ...
 */
package com.golrangsystem.persianmaterialdatetimepicker.time;
...
import com.golrangsystem.persianmaterialdatetimepicker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
  ...
  private void setMinute(int value) {
    ...
    CharSequence text =
        LanguageUtils.getPersianNumbers(String.format(Locale.getDefault(), "%02d", value));
    Utils.tryAccessibilityAnnounce(mTimePicker, text);
