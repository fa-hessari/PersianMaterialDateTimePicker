package com.golrangsystem.persianmaterialdatetimepicker.sample;
...
import com.golrangsystem.persianmaterialdatetimepicker.date.DatePickerDialog;
import com.golrangsystem.persianmaterialdatetimepicker.multidate.MultiDatePickerDialog;
import com.golrangsystem.persianmaterialdatetimepicker.time.RadialPickerLayout;
import com.golrangsystem.persianmaterialdatetimepicker.time.TimePickerDialog;
...
public class MainActivity extends AppCompatActivity
  ...
  private static final String TIMEPICKER = "TimePickerDialog", DATEPICKER = "DatePickerDialog",
      MULTIDATEPICKER = "MultiDatePickerDialog";
    ...
    switch (view.getId()) {
      case R.id.time_button: {
        ...
        TimePickerDialog tpd =
            TimePickerDialog.newInstance(MainActivity.this, now.get(PersianCalendar.HOUR_OF_DAY),
                now.get(PersianCalendar.MINUTE), mode24Hours.isChecked());
      ...
      case R.id.date_button: {
        PersianCalendar now = new PersianCalendar();
        DatePickerDialog dpd = DatePickerDialog.newInstance(MainActivity.this, now.getPersianYear(),
            now.getPersianMonth(), now.getPersianDay());
  ...
  public void onDateSet(MultiDatePickerDialog view, ArrayList<PersianCalendar> selectedDays) {
    ...
    for (PersianCalendar calendar : selectedDays) {
      date.append(calendar.getPersianDay())
          .append("/")
          .append(calendar.getPersianMonth() + 1)
          .append("/")
          .append(calendar.getPersianYear())
          .append("\n\t");
    }
